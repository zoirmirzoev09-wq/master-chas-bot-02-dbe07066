...
const servicesData: ServiceCategory[] = [
  ...
  { 
    ...
    subCategories: [
      {
        icon: "🏚️",
        title: "Подвалы и гаражи",
        items: [
          { service: "Покраска стен и потолка", unit: "м²", min: "15", avg: "25", max: "40", note: "Бетон, побелка, влага" },
          { service: "Монтаж освещения (влагозащита)", unit: "точка", min: "25", avg: "40", max: "80", note: "Плафоны, IP-защита" },
          { service: "Разводка электрики по подвальным помещениям", unit: "п.м.", min: "20", avg: "35", max: "60", note: "Металлические трубы, гофра" },
          { service: "Уборка мусора, пыли, паутины", unit: "м²", min: "8", avg: "12", max: "20", note: "Без вывоза" },
          { service: "Вывоз хлама (до 100 кг)", unit: "объект", min: "100", avg: "180", max: "250", note: "Автомобиль, разгрузка" },
          { service: "Обшивка стен шифером/OSB", unit: "м²", min: "40", avg: "65", max: "100", note: "С крепежом и разметкой" },
          { service: "Герметизация щелей, швов", unit: "п.м.", min: "15", avg: "25", max: "40", note: "Пеной или цементом" },
        ],
      },
    ]
  },
  { 
    ...
    subCategories: [
      {
        icon: "🔑",
        title: "Ремонт под ключ (расчёт по м²)",
        items: [
          { service: "Бюджетный (Классика, Минимализм)", unit: "м²", min: "600", avg: "700", max: "800", note: "Простой дизайн, стандартные работы" },
          { service: "Средний сегмент (Modern, Лофт)", unit: "м²", min: "800", avg: "900", max: "1000", note: "Визуальные решения, освещение" },
          { service: "Премиум (Неоклассика, Хайтек)", unit: "м²", min: "1100", avg: "1400", max: "1800", note: "Встроенный свет, гипс, авторский надзор" },
        ],
      },
    ]
  },
